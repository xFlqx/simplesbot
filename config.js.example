var config = {
	ownerID: '242754701689356288', // Your ID here
	token: 'NzY1OTc4MzIzMzQzMjQ1MzMz.X4cq5w.TLSijgsrhydolrfx9Nnyd_6alI8', // Your bot token here
  ...
  googleAPIToken: 'AIzaSyCtH_j12J6qbT4v37Zjgm3rO1qrG2BlAio', // Used for link shortener and music features. You need to have these APIs enabled.
  ...
  musicEnabled: 'true',
	defaultSettings: {
		...
		modLogChannel: '》logs',
		modRole: 'Staff ✘ Team',
		adminRole: 'Team ✘ Leaders',
		welcomeChannel: '》welcome',
		welcomeMessage: 'Welcome {{user}} to Simple ╎ Support, to see the server go to <#765514936100454410>',
		welcomeEnabled: 'true',
		...
		swearFilter: 'true',
		swearWords: ['cunt', 'fuck', 'nigga', 'nibba', 'ni66a', 'n1gga', 'nlgga', 'shit', 'ass', 'kys', 'bitch', 'dick', 'retard'], // An array of swear words. These should be lowercase. (of course, I have not included much for certain reasons...)
		logDeletes: 'true',
		logNewMember: 'true',
		logMemberLeave: 'true',
